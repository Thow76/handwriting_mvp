...
/// the ordered list of bespoke rectangular [WaypointSection]s the stroke must
/// pass through in order, used by path scoring; empty for strokes scored only
/// on start position and stroke count.
///
